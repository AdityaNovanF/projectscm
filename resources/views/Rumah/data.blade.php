        ...
        <div class="box box-warning">
            <div class="box-header">
                <p>
                    ...
                    <a href='{{ url('/Rumah/form') }}' class="btn btn-sm btn-flat btn-primary"><i class="fa fa-plus"></i> Tambah Data Rumah</a>
                    @endif
                </p>
            </div>
            <div class="box-body">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="width:100px">
                                        <!-- <a href="/KPembangunan/detail/{{$r->id}}" class="btn btn-primary btn-sm">Data Barang</a> -->
